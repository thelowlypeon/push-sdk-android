...
public class NotificationFactory {
    ...
    private NotificationChannel getNotificationChannel(Context context) {
        ...
        if (notificationChannel == null) {
            notificationChannel = new NotificationChannel(channelId, channelId, importance);
            ...
            if (notificationChannel.getImportance() != importance) {
                channelId = channelId + "_" + importance;
                notificationChannel = new NotificationChannel(channelId, channelId, importance);
