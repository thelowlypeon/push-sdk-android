...
class LocalObjectKeys {
    ...
    static final LocalObject<Person> currentPerson =
            new LocalObject<>("VIBES_CURRENT_PERSON_DETAILS", new Person.PersonObjectFactory());
    ...
    static final String pushData = "VIBES_PUSH_DATA";
}
