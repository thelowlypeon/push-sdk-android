...
public class ResourceClientTest extends TestConfig {
    ...
    private SSLSocketFactory sslSocketFactory() {
        try {
            String keystorePath = getClass().getClassLoader().getResource("testkeystore.jks").getPath();
            ...
            Log.e(TAG, "Failed to create SSLSocketFactory: ", exception);
            throw new IllegalStateException("SSL configuration failed", exception);
        }
    }
}
