...
public class VibesTest {
    ...
    public void trackLaunchEventFailure() throws Exception {
        ...
        StubPersistentEventStorage eventStorage = new StubPersistentEventStorage();
        Vibes vibes = new Vibes(appId, api, credentialManager, eventStorage, new StubActivityLifecycleListener());
        Vibes.initialize(RuntimeEnvironment.application.getBaseContext(), "appid");
    ...
    public void getCurrentLoggerWithLoggerSpecified() {
        ...
        Vibes vibes = new Vibes("appid", new StubAPI(), new StubCredentialManager(), new StubPersistentEventStorage(), new StubActivityLifecycleListener());
        vibes.initialize(RuntimeEnvironment.application.getBaseContext(), "appid", "apiurl", customLogger);
    ...
    public void getCurrentLoggerWithoutLoggerSpecified() {
        Vibes vibes = new Vibes("appid", new StubAPI(), new StubCredentialManager(), new StubPersistentEventStorage(), new StubActivityLifecycleListener());
        vibes.initialize(RuntimeEnvironment.application.getBaseContext(), "appid", "apiurl");
