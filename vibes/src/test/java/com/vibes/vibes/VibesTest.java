...
public class VibesTest {
    ...
    public void trackLaunchEventPerSecondLimit() throws Exception {
        ...
        assertThat(eventStorage.storedEvents().getEvents().size(), is(1));
        assertThat(eventStorage.storedEvents().getEvents().get(0).getUUID(), not(tomorrowEvent2.getUUID()));
        ...
        assertThat(eventStorage.storedEvents().getEvents().size(), is(1));
        assertThat(eventStorage.storedEvents().getEvents().get(0).getUUID(), is(tomorrowPlusSecondEvent.getUUID()));
    }
