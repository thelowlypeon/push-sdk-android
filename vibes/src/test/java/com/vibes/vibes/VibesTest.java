...
public class VibesTest {
    ...
    public void trackMultipleEventTypesSuccess() throws Exception {
        ...
        Event event1 = new Event(TrackedEventType.LAUNCH, new HashMap<String, String>(), yesterday.getTime());
        Event event2 = new Event(TrackedEventType.LAUNCH, new HashMap<String, String>(), new Date());
        Event event3 = new Event(TrackedEventType.CLICKTHRU, new HashMap<String, String>(), new Date());
        Event event4 = new Event(TrackedEventType.INBOX_OPEN, new HashMap<String, String>(), new Date());
        ...
        assertThat(eventStorage.storedEvents().getEvents().size(), is(1));
        assertThat(eventStorage.storedEvents().getSortedEvents().first(), is(event2));

        vibes.trackEvents(Collections.singletonList(event3));
        assertThat(eventStorage.storedEvents().getEvents().size(), is(0));

        vibes.trackEvents(Collections.singletonList(event4));
        assertThat(eventStorage.storedEvents().getEvents().size(), is(0));
    }
    ...
    public void trackLaunchEventPerSecondLimit() throws Exception {
        ...
        vibes.trackEvents(Arrays.asList(tomorrowPlusSecondEvent));

        //new addition will be accepted because it is 1 more seconnd than the most recent record
        assertThat(eventStorage.storedEvents().getEvents().size(), is(1));
