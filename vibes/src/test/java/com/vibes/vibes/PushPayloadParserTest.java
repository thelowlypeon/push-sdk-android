...
public class PushPayloadParserTest {
    ...
    public void setUp() throws Exception {
        ...
        map.put("vibes_collapse_id", "test_type_a");
        this.map = map;
    ...
    @Test
    public void retrieveVibesCollapseId() throws Exception {
        assertThat(pushPayloadParser.getVibesCollapseId(), is("test_type_a"));
    }
