...
public class EventCollectionTest extends TestConfig {
    ...
    public void setUp() throws Exception {
        ...
        for (int i = 0; i < count; i++) {
            TrackedEventType type = getForIndex(i);
            HashMap<String, String> properties = new HashMap<String, String>();
            properties.put("key", "value");
            Calendar today = Calendar.getInstance();
            today.set(Calendar.SECOND, i);
            events.add(new Event(type, properties, today.getTime()));
        }
    ...
    public void removeItem() throws Exception {
        Event ev = collection.getSortedEvents().first();
    ...
    public void createInstance() throws Exception {
        ...
        assertThat(collection.getSortedEvents().first().getUUID(), is(instance.getSortedEvents().first().getUUID()));
        assertThat(collection.getSortedEvents().first().getProperties(), is(instance.getSortedEvents().first().getProperties()));
        assertThat(collection.getSortedEvents().first().getTimestamp(), is(instance.getSortedEvents().first().getTimestamp()));
    ...
    public void serialize() throws Exception {
        ...
        int index1 = 1;
        int index2 = 4;
        Event event1 = collection.getIndexedEvents().get(index1);
        Event event2 = collection.getIndexedEvents().get(index2);
    ...
    private TrackedEventType getForIndex(int number) {
        List<TrackedEventType> eventTypes = Arrays.asList(TrackedEventType.values());
        int index = number % 3;
